...
//
//	docker run quay.io/vauxoo/islamicrelief:islamicrelief-19.0-51859fb
//
...
// development instance reports the branch it is working on, "develop-18.0-dev1-moy", which also
